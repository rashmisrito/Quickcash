...
export default function List() {
  ...
  const account_id = jwtDecode<JwtPayload>(localStorage.getItem('admintoken') as string);
  ...
  const getList = async () => {
    await axios.get(`/${url}/v1/ecommerce/adminlist/${account_id?.data?.id}`,{
      headers: {
  ...
  const getUserDetails = async () => {
    await axios.post(`/${url}/v1/user/admin/list`,{},{
      headers: 
      {
       'Authorization': `Bearer ${localStorage.getItem('admintoken')}`
      }
  ...
  const getItemDetails = async (val:any) => {
    await axios.get(`/${url}/v1/ecommerce/admin/ecommerce/${val}`, 
    { 
      headers: {
       'Authorization': `Bearer ${localStorage.getItem('admintoken')}`
      }
  ...
  const getViewDetails = async (val:any) => {
    await axios.get(`/${url}/v1/ecommerce/admin/transaction/${val}`, 
    { 
      headers: {
       'Authorization': `Bearer ${localStorage.getItem('admintoken')}`
     }
  ...
  const HandleCreateEcommerce = async () => {
    ...
    await axios.post(`/${url}/v1/ecommerce/admin/add`, 
    {
  ...
  const HandleUpdateEcommerce = async () => {
    await axios.patch(`/${url}/v1/ecommerce/admin/update/${ecommid}`, 
    {
  ...
  const HandleSendPaymentLink = async (val:any) => {
    ...
    if(r == true) {
      await axios.get(`/${url}/v1/ecommerce/admin/sendlink/${val}`, 
      { 
        headers: {
         'Authorization': `Bearer ${localStorage.getItem('admintoken')}`
        }
  ...
  const HandleDeleteItem = async (val:any) => {
    ...
    if(r == true) {
      await axios.delete(`/${url}/v1/ecommerce/admin/delete/${val}`, {
        headers: 
        {
          'Authorization': `Bearer ${localStorage.getItem('admintoken')}`
        }
        ...
        <TableContainer component={Paper}>
          ...
          <div ref={targetRef}>
            ...
            <TableRow key={row?.date}>
             ...
             {
              (row?.status == "Complete" || row?.status == "Approved" || row?.status == "Test") &&
              <>
