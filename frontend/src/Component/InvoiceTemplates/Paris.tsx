...
export default function Paris({color}:any) {
  ...
  return (
    <div>
      ...
      <Grid sx={{marginTop: '10px'}}><img src={InvoiceLogo} width="140px" /></Grid>

      <Grid>
        <Grid sx={{fontSize: '14px',color: `${theme ? 'white' : 'black'}`}}>FROM</Grid>
      ...
      <table width={"100%"} style={{marginTop: '20px',color: `${theme ? 'white' : 'black'}`}}>
        <tbody>
          <tr>
            <td>INVOICE ID:</td>
            <td style={{color: `${theme ? 'white' : '#7a7a7a'}`, fontSize: '14px'}}>#56PC98</td>
          </tr>
          <tr>
            <td>INVOICE DATE:</td>
            <td style={{color: `${theme ? 'white' : '#7a7a7a'}`, fontSize: '14px'}}>25 Nov 2020 8:03 AM</td>
          </tr>
          <tr>
            <td>DUE DATE:</td>
