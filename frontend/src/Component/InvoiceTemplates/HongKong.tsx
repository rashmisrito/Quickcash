...
export default function HongKong({color}:any) {
  const [theme]:any = useOutletContext();
  return (
    <div>
      <Grid sx={{marginTop: '10px'}}><img src={InvoiceLogo} width="150px" /></Grid>

      <Grid sx={{marginTop: '20px'}}>
        <Grid sx={{color: color, fontSize: '14px'}}>ITIO Invoice</Grid>
      ...
      <Grid sx={{color: color,fontSize: '30px', marginTop: '30px'}}>INVOICE</Grid>
      ...
      <table width={"100%"} border={1} style={{display: 'table', borderCollapse: 'collapse' ,color: `${theme ? 'white' : 'black'}`, borderColor: color}}>
        <thead>
