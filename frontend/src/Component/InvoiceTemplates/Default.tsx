...
export default function Default({color}:any) {

  const [theme]:any = useOutletContext();

  return (
    <Box sx={{ color: `${theme ? 'white' : 'black'}` }}>
      <Grid>INVOICE</Grid>
      ...
      <Grid sx={{marginTop: '16px'}}>To</Grid>
      ...
      <table width={"100%"} style={{marginTop: '20px'}}>
        <tbody>
          ...
          <tr>
            <td>Invoice Date: 25th Nov, 2020 8:03 AM</td>
          </tr>
          <tr>
            <td>Due Date: 26th Nov, 2020</td>
          </tr>
        </tbody>
      </table>
      ...
      <Grid sx={{marginBottom: '10px'}}>Notes:</Grid>
      ...
      <Grid sx={{marginTop: '20px'}}>Terms:</Grid>
